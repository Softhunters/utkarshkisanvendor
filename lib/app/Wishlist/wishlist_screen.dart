                                          ...
                                          children: [
                                            ...
                                            Consumer<CurrencyProvider>(
                                              builder: (context,
                                                ...
                                                builder: (context,
                                                    salePriceSnapshot) {
                                                  if (!salePriceSnapshot
                                                      .hasData) {
                                                    return Text("loading");
                                                  }
                                                  double salePrice =
                                                      salePriceSnapshot.data ??
                                                          0.0;
                                              ...
                                              builder: (context, cartController,
                                                ...
                                                children: [
                                                  Expanded(
                                                    ...
                                                    onTap: () async{
                                                      await controller.addWishlistProduct(
                                                          data.productId,
                                                          2,
                                                          (data.sellerId == null || data.sellerId == "null") ? "1" : data.sellerId??'1'
                                                      );
                                                      await controller.getWishlistProduct(1);
                                                    },
                                                    child: Container(
                                                      width: width * .2,
                                                      // height: 2,

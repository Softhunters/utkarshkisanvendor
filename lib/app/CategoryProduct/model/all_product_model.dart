...
class AllShopProduct {
  bool? status;
  Result? result;

  AllShopProduct({this.status, this.result});

  AllShopProduct.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    result =
...
class Result {
  ...
  Result({this.products,this.perPage});

  Result.fromJson(Map<String, dynamic> json) {
    perPage = json['per_page'].toString();
    products = json['products'] != null
        ?  ShopProduct.fromJson(json['products'])
        : null;
  }
